...
batteryRouter.get('/', expressAsyncHandler(async (req, res) => {
...
batteryRouter.get('/:id', expressAsyncHandler(async (req, res) => {
...
batteryRouter.post('/', expressAsyncHandler(async (req, res) => {
...
batteryRouter.put('/:id', expressAsyncHandler(async (req, res) => {
...
batteryRouter.delete('/:id', expressAsyncHandler(async (req, res) => {
    const battery = await Battery.findById(req.params.id);
    if (battery) {
...
batteryRouter.post('/filter', expressAsyncHandler(async (req, res) => {
    const battery = new Battery({
        name: 'sample name' + Date.now(),
        image: '/images/picture-1.jpeg',
        type: 'sample type',
